...
//            m_edit_mesh->bake_rotation(tc->world_orientation());
//            m_edit_mesh->bake_translation(tc->world_position());
//        }
//        else
//        {
//            m_edit_mesh->bake_node_scaling(tc->scaling());
//            m_edit_mesh->bake_node_rotation(tc->world_orientation());
//            m_edit_mesh->bake_node_translation(tc->world_position());
//        }
//    }
//    m_edit_mesh = NULL;
}
